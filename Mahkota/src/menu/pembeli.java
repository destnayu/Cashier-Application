 ...
 * @author ayu yanti
 */
public final class pembeli extends javax.swing.JFrame {
...
private void id() {
        try{
 String sql = "SELECT id_pembeli FROM pembeli order by id_pembeli asc";
 Statement stat = conn.createStatement();
 ResultSet rs=stat.executeQuery(sql);

 while(rs.next()){
 String id_pembeli = rs.getString("id_pembeli").substring(2);
 int nomor = Integer.parseInt(id_pembeli) + 1;
 String nol = "";
...
public void removeTable(){
    ...
    private void initComponents() {
        ...
        datapembeli = new javax.swing.JTable();
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(tfhp, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        datapembeli.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(datapembeli);
 ...
 jenis = "P";
        ...
        try{
            String sql = "update pembeli set nama_pembeli=?,alamat=?,jenis_kelamin=?,no_hp=? where id_pembeli='"+tfid.getText()+"'";
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, tfnama.getText());
            stat.setString(2, taalamat.getText());
            stat.setString(3, jenis);
            stat.setString(4, tfhp.getText());
            stat.executeUpdate();
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        if (ok==0){
            String sql = "delete from pembeli where id_pembeli ='"+tfid.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void datapembeliMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_datapembeliMouseClicked
        // TODO add your handling code here:
        int bar = datapembeli.getSelectedRow();
 ...
 int jumdata=0;
 removeTable();
 String sql ="SELECT * FROM pembeli where id_pembeli like '%"+cari+"%' or nama_pembeli like '%"+cari+"%' order by id_pembeli asc";
 ...
 JOptionPane.showMessageDialog(null,"Data Gagal Masuk Tabel"+sqle);
    ...
    private javax.swing.JTable datapembeli;
